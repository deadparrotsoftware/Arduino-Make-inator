		...
		Sub InitControl()
		  ...
		  for i = 0 to 10
		    ...
		    if ControlType = kcWindow then
		      x(i) = 20
		      y(i) = 25
		      if i = app.kTargetWeb then
		        Height(i) = 300
		        Width(i) = 300
		      ElseIf i = app.kTargetDesktop then
		        Height(i) = 300
		        Width(i) = 300
		      elseif i = app.kTargetPhone then
		        Height(i) = 320
		        Width(i) = 240
		      elseif i = app.kTargetTablet then
		        Height(i) = 1280
		        Width(i) = 800
		      end if
		      Text(i) = "Window"
