...
Begin Menu MenuBar1
   ...
   Begin MenuItem ProjectMenu
      ...
      Begin MenuItem ProjectBuildProjectHTML5Web
         ...
         AutoEnable = True
      End
      Begin MenuItem ProjectBuildProjectHTML5Desktop
         SpecialMenu = 0
         Text = "Build Project - HTML5 - Desktop"
         Index = -2147483648
         AutoEnable = True
      End
      Begin MenuItem ProjectBuildProjectHTML5Phone
         SpecialMenu = 0
         Text = "Build Project - HTML5 - Phone"
         Index = -2147483648
         AutoEnable = True
      End
      Begin MenuItem ProjectBuildProjectHTML5Tablet
         SpecialMenu = 0
         Text = "Build Project - HTML5 - Tablet"
         Index = -2147483648
         AutoEnable = True
      End
   ...
   Begin MenuItem HelpMenu
      ...
      Begin MenuItem HelpWelcomeToIlluminationSoftwareCreator
         SpecialMenu = 0
         Text = "Welcome To Arduino-Make-inator!"
         Index = -2147483648
         AutoEnable = True
      End
      ...
      Begin AppleMenuItem HelpAboutIlluminationSoftwareCreator
         SpecialMenu = 0
         Text = "About Arduino-Make-inator!"
         Index = -2147483648
         AutoEnable = True
      End
   End
