#tag Class
Protected Class ilObjectArduinoDigitalRead
Inherits ilObjectBase
	#tag Event
		Sub GenerateArduinoCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + modVariables.VariableObjectFromName(OriginVariable).ISCArduinoName + " = digitalRead(" + _
		  modVariables.VariableObjectFromName(MathVariable1).ISCArduinoName +");" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscArduinoDigitalRead"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Digital Read"
		  me.DisplayCategory = "Arduino"
		  me.Title = "Digital Read"
		  me.Width = 90
