#tag Class
Protected Class ilObjectPenSetFontAllignment
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "iscPenFontAllignment = """ + MessageFromVariable + """;" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscPenSetFontAllignment"
		  me.BGColor =  frmProject.kcolPicture
		  me.DisplayName = "Set Pen Font Allignment"
		  me.DisplayCategory = "Graphics"
		  me.Title = "Set Pen Font Align"
		  me.Width = 90
