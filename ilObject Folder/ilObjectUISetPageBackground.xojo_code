#tag Class
Protected Class ilObjectUISetPageBackground
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "document.body.style.backgroundImage = 'url(""ISCimages/" +  _
		  modVariables.getProjectImageFromName(MessageFromVariable).ActualFileName + _
		  """)';" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscSetPageBackground"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Set Page Background"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Set Page Background"
		  me.Width = 90
