#tag Class
Protected Class ilObjectArduinoDelay
Inherits ilObjectBase
	#tag Event
		Sub GenerateArduinoCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "delay(" + modVariables.VariableObjectFromName(MathVariable1).ISCArduinoName +");" + EndOfLine
		  
		  s = s + "//" + GetCodeName + "Done" + EndOfLine
		  
		  s = s + "}" + EndOfLine + EndOfLine
		  
		  setCodeToCallThisObjectForName("Delay", GetCodeName + "();")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscArduinoDelay"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Delay"
		  me.DisplayCategory = "Arduino"
		  me.Title = "Delay"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Delay"
