#tag Class
Protected Class ilObjectPenSetFont
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "iscPenFont = " + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + ";" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscPenSetFont"
		  me.BGColor =  frmProject.kcolPicture
		  me.DisplayName = "Set Pen Font"
		  me.DisplayCategory = "Graphics"
		  me.Title = "Set Pen Font"
		  me.Width = 90
