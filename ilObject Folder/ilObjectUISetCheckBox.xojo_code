...
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "if (" + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + " == 1)" + EndOfLine
		  s = s + "{" + EndOfLine
		  s = s + "document.getElementById(""" + tempILUI.ISCClassLocalFlexName + """).checked = true;" + EndOfLine
		  s = s + "}" + EndOfLine
		  s = s + "else" + EndOfLine
		  s = s + "{" + EndOfLine
		  s = s + "document.getElementById(""" + tempILUI.ISCClassLocalFlexName + """).checked = false;" + EndOfLine
		  s = s + "}" + EndOfLine
