#tag Class
Protected Class ilObjectOpenURL
Inherits ilObjectBase
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "window.open(" + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName +  ");" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscOpenURL"
		  me.BGColor =  frmProject.kcolDictionary
		  me.DisplayName = "Open URL"
