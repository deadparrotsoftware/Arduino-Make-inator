...
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  showTitle = theWindowObject.ShowTitle(modCodeGenerator.TargetInProcess)
		  
		  // Start the div panel
		  if theTarget = app.kTargetPhone or theTarget = app.kTargetTablet then
		    
		    's = "<div id=""" + theWindowObject.ISCClassLocalPythonName + """ class=""window"" style=""visibility:hidden;height:" + _
		    'str(theWindowObject.Height(modCodeGenerator.TargetInProcess)) + "px;width:" + _
		    'str(theWindowObject.Width(modCodeGenerator.TargetInProcess)) + "px;left:" + _
		    'str(theWindowObject.X(modCodeGenerator.TargetInProcess)) + "px;top:" + _
		    'str(theWindowObject.Y(modCodeGenerator.TargetInProcess)) + "px;position:absolute"">" + EndOfLine
		    
		    s = "<div id=""" + theWindowObject.ISCClassLocalPythonName + """ class=""window"" style=""visibility:hidden;" + _
		    "opacity:" + str(theWindowObject.Opacity(modCodeGenerator.TargetInProcess)) + ";" + _
		    "height:100%;width:100%;left:0px;top:0px;position:absolute"">" + EndOfLine
		    
		  else
		    
		    s = "<div id=""" + theWindowObject.ISCClassLocalPythonName + """ class=""window"" style=""visibility:hidden;" + _
		    "opacity:" + str(theWindowObject.Opacity(modCodeGenerator.TargetInProcess)) + ";height:" + _
		  ...
		  dim titleAdjust as integer
		  dim labelColorS as string
		  ...
		  if theUIObjects.Ubound > -1 then
		    for i = 0 to theUIObjects.Ubound
		      ...
		      if theUIObjects(i).ControlType = theUIObjects(i).kcButton then
		        ...
		        // The Div and Form
		        if theTarget = app.kTargetPhone or theTarget = app.kTargetTablet then
		          s = s + "<div id=""" + theUIObjects(i).ISCClassLocalPythonName + "div""" + _
		          " style=""opacity:" + str(theUIObjects(i).Opacity(modCodeGenerator.TargetInProcess)) + ";" + _
		          "position: absolute; left: " + str(theUIObjects(i).X(modCodeGenerator.TargetInProcess)) + _
		          "px; top: " + str(theUIObjects(i).Y(modCodeGenerator.TargetInProcess)) + "px;"">" + EndOfLine
		        else
		          if showTitle = true then
		            titleAdjust = 28
		          else
		          ...
		          " style=""opacity:" +  str(theUIObjects(i).Opacity(modCodeGenerator.TargetInProcess)) + ";" + _
		          "position: absolute; left: " + str(theUIObjects(i).X(modCodeGenerator.TargetInProcess)) + _
		          "px; top: " + str(theUIObjects(i).Y(modCodeGenerator.TargetInProcess) + titleAdjust) + "px;"">" + EndOfLine
		        end if
		        ...
		        s = s + "<button class=""amibutton"" id=""" + theUIObjects(i).ISCClassLocalPythonName + _
		        """ onClick=""" + GetCodeName + theUIObjects(i).ContentOutputName + "()" + _
		        """ style=""width:" + str(theUIObjects(i).Width(modCodeGenerator.TargetInProcess)) + "px;" + _
		        " height:" + str(theUIObjects(i).Height(modCodeGenerator.TargetInProcess)) + "px""" + _
		        ">" + str(theUIObjects(i).Text(modCodeGenerator.TargetInProcess)) + "</button>" + EndOfLine
		        
		        //<button class="amibutton" style="width:240px; height:36px">// About Bryan Lunduke</button>
		      ...
		      if theUIObjects(i).ControlType = theUIObjects(i).kcLabel then
		        ...
		        if theTarget = app.kTargetPhone or theTarget = app.kTargetTablet then
		          ...
		          " style=""opacity:" + str(theUIObjects(i).Opacity(modCodeGenerator.TargetInProcess)) + ";" + _
		          "position: absolute; left: " + str(theUIObjects(i).X(modCodeGenerator.TargetInProcess)) + _
		          "px; top: " + str(theUIObjects(i).Y(modCodeGenerator.TargetInProcess)) + "px;" + _
		          ...
		          " style=""opacity:" + str(theUIObjects(i).Opacity(modCodeGenerator.TargetInProcess)) + ";" + _
		          "position: absolute; left: " + str(theUIObjects(i).X(modCodeGenerator.TargetInProcess)) + _
		          "px; top: " + str(theUIObjects(i).Y(modCodeGenerator.TargetInProcess) + titleAdjust) + "px;" + _
		          " width: " + str(theUIObjects(i).Width(modCodeGenerator.TargetInProcess)) + "px;" + _
		          " height: " + str(theUIObjects(i).Height(modCodeGenerator.TargetInProcess)) + "px;" + _
		          """>" + EndOfLine
		        end if
		        ...
		        """ style=""color:rgb(" + str(theUIObjects(i).BackgroundColor(modCodeGenerator.TargetInProcess).red) + "," + _
		        str(theUIObjects(i).BackgroundColor(modCodeGenerator.TargetInProcess).Green) + "," + _
		        str(theUIObjects(i).BackgroundColor(modCodeGenerator.TargetInProcess).Blue) + _
		      ...
		      if theUIObjects(i).ControlType = theUIObjects(i).kcTextBox then
		        ...
		        //s = s + "<form>" + EndOfLine
		        s = s + "<input class=""amitextbox"" type=""text"" id=""" + theUIObjects(i).ISCClassLocalPythonName + _
		        """ style='width:" + str(theUIObjects(i).Width(modCodeGenerator.TargetInProcess) - 20) + _
		      ...
		      if theUIObjects(i).ControlType = theUIObjects(i).kcCheckBox then
		        ...
		        //s = s + "<form>" + EndOfLine
		        s = s + "<input type=""checkbox"" id=""" + theUIObjects(i).ISCClassLocalPythonName + _
		        """ value=""" +  str(theUIObjects(i).Text(modCodeGenerator.TargetInProcess)) + """ onChange=""" + _
		        GetCodeName + theUIObjects(i).ContentOutputName + "()"">" + str(theUIObjects(i).Text(modCodeGenerator.TargetInProcess)) + EndOfLine
		        //s = s + "</form>" + EndOfLine
		        s = s + "</div>" + EndOfLine
		        
		      end if
		      
		      // Insert the Web Browser
		      if theUIObjects(i).ControlType = theUIObjects(i).kcWebBrowser then
		      ...
		      if theUIObjects(i).ControlType = theUIObjects(i).kcColorButton then
		        ...
		        s = s + "<input id=""" + theUIObjects(i).ISCClassLocalPythonName + """ name=""" + theUIObjects(i).ISCClassLocalPythonName +_
		        """ type=""color"" style=""width:" + str(theUIObjects(i).Width(modCodeGenerator.TargetInProcess)) + _
		        "px; height:" + str(theUIObjects(i).Height(modCodeGenerator.TargetInProcess)) + _
		        "px;"" onChange=""" + GetCodeName + theUIObjects(i).ContentOutputName + "()" + _
		        """/>" + EndOfLine
		      ...
		      if theUIObjects(i).ControlType = theUIObjects(i).kcCanvas then
		        ...
		        if theTarget = app.kTargetPhone or theTarget = app.kTargetTablet then
		          s = s + "<div id=""" + theUIObjects(i).ISCClassLocalPythonName + "div""" + _
		          " style=""opacity:" + str(theUIObjects(i).Opacity(modCodeGenerator.TargetInProcess)) + ";" + _
		          "position: absolute; left: " + str(theUIObjects(i).X(modCodeGenerator.TargetInProcess)+1) + _
		          "px; top: " + str(theUIObjects(i).Y(modCodeGenerator.TargetInProcess)) + "px;"">" + EndOfLine
		        else
		          if showTitle = true then
		            titleAdjust = 29
