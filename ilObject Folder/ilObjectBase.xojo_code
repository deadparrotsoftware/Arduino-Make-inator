...
Protected Class ilObjectBase
	...
	#tag Method, Flags = &h0
		Sub ArduinoInsertCodeAtMarker(theCode as string, theMarker as string)
		  ...
		  modCodeGenerator.ArduinoCode = modCodeGenerator.ArduinoCode.Replace(theMarker, theCode)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub CallGenerateArduinoCode(optional TheTarget as integer)
		  GenerateArduinoCode("",TheTarget)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub CallGenerateJavascriptWebCode(optional TheTarget as integer)
		  GenerateJavaScriptWebCode("",TheTarget)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub HelperGenerateArduinoCodePhase2(theSourceObject as contentObject, theDestinationObject as contentObject)
		  dim sCommentTag as string
		  dim sReplacementCode as string
		  ...
		  ArduinoInsertCodeAtMarker(sReplacementCode,sCommentTag)
	...
	#tag Hook, Flags = &h0
		Event GenerateArduinoCode(theOrigin as string, optional theTarget as integer)
	#tag EndHook
	...
	#tag Hook, Flags = &h0
		Event GenerateiOSCodeNew(theOrigin as string)
	#tag EndHook

	#tag Hook, Flags = &h0
		Event GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
	#tag EndHook
