#tag Class
Protected Class ilObjectAnimationShake
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  if varControlName = "The Window" then
		    s = s + "new Effect.Shake('" + tempILWindow.theWindowObject.ISCClassLocalFlexName + "');" + EndOfLine
		  else
		    s = s + "new Effect.Shake('" + tempILUI.ISCClassLocalFlexName + "div');" + EndOfLine
		  end if
		  ...
		  setCodeToCallThisObjectForName("Shake", GetCodeName + "();")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscShake"
		  me.BGColor =  frmProject.kcolAnimation
		  me.DisplayName = "Shake"
		  me.DisplayCategory = "Animation"
		  me.Title = "Shake"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Shake"
