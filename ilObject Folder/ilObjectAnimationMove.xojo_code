#tag Class
Protected Class ilObjectAnimationMove
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  if varControlName = "The Window" then
		    s = s + "new Effect.Move('" + tempILWindow.theWindowObject.ISCClassLocalFlexName + "', { x: " + _
		    modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalFlexName + _
		    ", y: "+ modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalFlexName + _
		    ", mode: '" + Lowercase(MessageFromVariable) + "' });" + EndOfLine
		    
		  else
		    s = s + "new Effect.Move('" + tempILUI.ISCClassLocalFlexName + "div', { x: " + _
		    modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalFlexName + _
		    ", y: "+ modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalFlexName + _
		    ", mode: 'relative' });" + EndOfLine
		  ...
		  setCodeToCallThisObjectForName("Move", GetCodeName + "();")
