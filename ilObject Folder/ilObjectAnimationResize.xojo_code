#tag Class
Protected Class ilObjectAnimationResize
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "var w1 = " + modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalFlexName + ".toString();" + EndOfLine
		  s = s + "var h1 = " + modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalFlexName + ".toString();" + EndOfLine
		  
		  s = s + "new Effect.Morph('" + tempILUI.ISCClassLocalFlexName + "', { style: 'width:' + w1 + 'px; height:' + h1 + 'px', duration: " + _
		  ...
		  setCodeToCallThisObjectForName("Resize", GetCodeName + "();")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscResize"
		  me.BGColor =  frmProject.kcolAnimation
		  me.DisplayName = "Resize"
		  me.DisplayCategory = "Animation"
		  me.Title = "Resize"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Resize"
