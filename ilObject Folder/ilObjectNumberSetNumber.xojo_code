...
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateArduinoCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + modVariables.VariableObjectFromName(OriginVariable).ISCArduinoName + " = "
		  
		  if UseVariableForMessage = true then
		    s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCArduinoName + ";" + EndOfLine
		  else
		    s = s + CustomMessage + ";" + EndOfLine
		  end if
