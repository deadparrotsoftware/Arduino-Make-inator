#tag Class
Protected Class ilObjectPenSetColor
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "iscPenColor = " + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + ";" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscPenSetColor"
		  me.BGColor =  frmProject.kcolPicture
		  me.DisplayName = "Set Pen Color"
		  me.DisplayCategory = "Graphics"
		  me.Title = "Set Pen Color"
		  me.Width = 90
