#tag Class
Protected Class ilObjectDictionarySave
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string, optional theTarget as integer)
		  ...
		  s = s + "var toJSON = JSON.stringify(" +  modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + ");" + EndOfLine
		  
		  s = s + "localStorage." + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + " = " + _
		  "toJSON;" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscDictSave"
		  me.BGColor =  frmProject.kcolDictionary
		  me.DisplayName = "Save Dictionary"
		  me.DisplayCategory = "Dictionaries"
		  me.Title = "Save Dictionary"
		  me.Width = 90
